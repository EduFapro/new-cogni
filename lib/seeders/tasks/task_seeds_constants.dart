...
const String whatWasYourProfessionTaskTitle = 'Profissão';
...
const String doYouExerciseFrequentlyTaskTitle = 'Exercícios físicos';
...
const String doYouHaveAnyDiseasesTaskTitle = 'Doenças diagnosticadas';

// Cognitive functions
const int payCloseAttentionTaskID = 11;
const String payCloseAttentionTaskTitle = 'Preste bastante atenção';

const int subtracting3AndAgainTaskID = 12;
const String subtracting3AndAgainTaskTitle = 'Cálculo seriado';
...
const String whatMonthAreWeInTaskTitle = 'Em que mês estamos?';

const int whatDayOfTheMonthIsItTaskID = 15;
const String whatDayOfTheMonthIsItTaskTitle = 'Que dia do mês é hoje?';

const int whatDayOfTheWeekIsItTaskID = 16;
const String whatDayOfTheWeekIsItTaskTitle = 'Que dia da semana é hoje?';
...
const String retellStoryTaskTitle = 'Conte a história novamente';
...
const String pressaInimigaTaskTitle = 'A pressa é inimiga da perfeição';

const int conteAte5TaskID = 9002;
const String conteAte5TaskTitle = 'Conte até 5';
